...
const ages = [
  { num: 'U13', label: 'Under 13', sub: 'Future stars', slug: 'u13' },
  { num: 'U15', label: 'Under 15', sub: 'Rising talent', slug: 'u15' },
  { num: 'U19', label: 'Under 19', sub: 'Elite prospects', slug: 'u19' },
  { num: 'U23', label: 'Under 23', sub: 'Senior pathway', slug: 'u23' },
]
    ...
    <section className="px-10 py-16 bg-black/50 backdrop-blur-md">
      ...
      <div className="grid grid-cols-4 gap-5">
        {ages.map(a => (
          <div
            key={a.num}
            onClick={() => navigate(`/age-category/${a.slug}`)}
            className="border border-green-400/30 rounded-2xl p-10 text-center hover:border-green-400 hover:bg-white/10 transition-all cursor-pointer"
          >
