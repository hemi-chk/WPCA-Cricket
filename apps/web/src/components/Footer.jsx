      ...
      <div className="px-10 py-16 grid grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 bg-[#1a6b3c] rounded-lg flex items-center justify-center text-lg">🏆</div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            {['Home', 'Players', 'Matches', 'Teams', 'Analytics'].map(l => (
              <li key={l}>
                <a href="#" className="text-white/50 text-sm hover:text-green-400 transition-colors">{l}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            {['Under 13', 'Under 15', 'Under 19', 'Under 23'].map(a => (
              <li key={a}>
                <a href="#" className="text-white/50 text-sm hover:text-green-400 transition-colors">{a}</a>
              </li>
            ))}
          </ul>
        </div>
